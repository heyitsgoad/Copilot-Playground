...
## Prompt 2 – Careful Reasoning Instructions

This prompt is designed to get the large language model to deliberate carefully about its answers before responding. It comes in two parts: (1) interpreting the question, and (2) reflecting on its answer. The easiest way to use this prompt is to copy and paste all the text below into ChatGPT or another language model, at the very beginning of a new chat. Then, when you ask questions in the same chat, the model will follow these custom instructions and answer in your preferred style.
